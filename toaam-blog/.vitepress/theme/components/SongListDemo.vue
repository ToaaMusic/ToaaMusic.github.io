...
const songs = [
  { id: 1, cover: 'A', artist: 'Camellia', title: 'GHOST', mapper: 'ToaaM', bpm: 200, length: '2:18', rank: '#01', ar: 9.7, od: 9.3, cs: 4.2, hp: 6.8 },
  { id: 2, cover: 'B', artist: 'xi', title: 'FREEDOM DiVE', mapper: 'peppy', bpm: 222, length: '2:43', rank: '#02', ar: 9.8, od: 9.5, cs: 4.0, hp: 6.5 },
  { id: 3, cover: 'C', artist: 'Laur', title: 'Sound Chimera', mapper: 'M Toaa', bpm: 210, length: '2:07', rank: '#03', ar: 9.5, od: 9.1, cs: 4.4, hp: 7.1 },
  { id: 4, cover: 'D', artist: 't+pazolite', title: 'Grievous Lady', mapper: 'Momo', bpm: 256, length: '1:57', rank: '#04', ar: 9.9, od: 9.7, cs: 4.1, hp: 7.4 },
  { id: 5, cover: 'E', artist: 'USAO', title: 'Valhalla', mapper: 'Neko', bpm: 180, length: '2:31', rank: '#05', ar: 9.2, od: 8.8, cs: 4.3, hp: 6.2 },
  { id: 6, cover: 'F', artist: 'DJ Okawari', title: 'Flower Dance', mapper: 'Yuki', bpm: 103, length: '4:10', rank: '#06', ar: 7.8, od: 7.2, cs: 3.8, hp: 5.0 },
  { id: 7, cover: 'G', artist: 'MARETU', title: 'Darling', mapper: 'Kira', bpm: 190, length: '2:26', rank: '#07', ar: 9.0, od: 8.9, cs: 4.0, hp: 6.6 },
  { id: 8, cover: 'H', artist: 'ZUN', title: 'Necrofantasia', mapper: 'Aki', bpm: 168, length: '3:58', rank: '#08', ar: 8.6, od: 8.4, cs: 4.7, hp: 6.0 },
]
