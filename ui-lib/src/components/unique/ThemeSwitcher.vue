...
<style scoped>
    ...
    .theme-switcher:hover {
        background-color: var(--button-hover-bg, rgba(230, 230, 230, 0.514));
        color: white;
    }
</style>
